...
class MovieCatalog implements ActionListener {
    ...
    MovieCatalog() {
        ...
        movieList.setBounds(50, 100, 300, 200);
        movieList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

        JLabel searchLabel = new JLabel("Search:");
        searchLabel.setBounds(50, 50, 50, 25);
        searchField.setBounds(110, 50, 150, 25);
        searchButton.setBounds(270, 50, 80, 25);

        searchButton.addActionListener(this);

        JButton selectButton = new JButton("Select Movie");
        selectButton.setBounds(150, 320, 120, 25);
...
class BookingScreen {
    ...
    BookingScreen(String movie) {
        ...
        ticketSpinner.addChangeListener(e -> {
            ...
            totalLabel.setText("Total: Php" + (tickets * 10));
        });
    }
}
